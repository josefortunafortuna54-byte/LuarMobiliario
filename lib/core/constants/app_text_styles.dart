...
abstract final class AppTextStyles {
  ...
  static TextStyle get h3 => _headingBase(
        fontSize: 32,
        fontWeight: FontWeight.w600,
        height: 1.2,
      );

  static TextStyle get h4 => _headingBase(
        fontSize: 28,
        fontWeight: FontWeight.w600,
        height: 1.25,
      );

  static TextStyle get h5 => _headingBase(
        fontSize: 24,
        fontWeight: FontWeight.w600,
        height: 1.3,
      );

  static TextStyle get h6 => _headingBase(
        fontSize: 20,
        fontWeight: FontWeight.w600,
        height: 1.3,
      );
  ...
  static TextStyle get bodyLarge => _bodyBase(
        fontSize: 18,
        fontWeight: FontWeight.w400,
        height: 1.6,
      );

  static TextStyle get bodyMedium => _bodyBase(
        fontSize: 16,
        fontWeight: FontWeight.w400,
        height: 1.5,
      );

  static TextStyle get bodySmall => _bodyBase(
        fontSize: 14,
        fontWeight: FontWeight.w400,
        height: 1.5,
      );

  static TextStyle get bodyTiny => _bodyBase(
        fontSize: 12,
        fontWeight: FontWeight.w400,
        height: 1.4,
      );
