  ...
  group('CustomButton', () {
    group('renders', () {
      testWidgets('displays text', (tester) async {
        await tester.pumpWidget(wrapInApp(
          const CustomButton(text: 'Salvar'),
        ));
      ...
      testWidgets('renders ElevatedButton for primary variant', (tester) async {
        await tester.pumpWidget(wrapInApp(
          const CustomButton(text: 'Primary', variant: CustomButtonVariant.primary),
        ));
        await tester.pumpAndSettle();
      ...
      testWidgets('renders ElevatedButton for secondary variant', (tester) async {
        await tester.pumpWidget(wrapInApp(
          const CustomButton(text: 'Secondary', variant: CustomButtonVariant.secondary),
        ));
        await tester.pumpAndSettle();
      ...
      testWidgets('renders OutlinedButton for outline variant', (tester) async {
        await tester.pumpWidget(wrapInApp(
          const CustomButton(text: 'Outline', variant: CustomButtonVariant.outline),
        ));
        await tester.pumpAndSettle();
    ...
    group('loading state', () {
      testWidgets('shows CircularProgressIndicator when loading', (tester) async {
        await tester.pumpWidget(wrapInApp(
          const CustomButton(text: 'Save', isLoading: true),
        ));
        await tester.pump();
      ...
      testWidgets('does not show CircularProgressIndicator when not loading',
          (tester) async {
        await tester.pumpWidget(wrapInApp(
          const CustomButton(text: 'Save', isLoading: false),
        ));
        await tester.pumpAndSettle();
    ...
    group('disabled state', () {
      testWidgets('button is disabled when enabled is false', (tester) async {
        await tester.pumpWidget(wrapInApp(
          const CustomButton(text: 'Off', enabled: false),
        ));
        await tester.pumpAndSettle();
      ...
      testWidgets('button is enabled when enabled is true', (tester) async {
        await tester.pumpWidget(wrapInApp(
          CustomButton(text: 'On', enabled: true, onPressed: () {}),
        ));
        await tester.pumpAndSettle();
    ...
    group('isFullWidth', () {
      testWidgets('wraps button in SizedBox when full width', (tester) async {
        await tester.pumpWidget(wrapInApp(
          const CustomButton(text: 'Full', isFullWidth: true),
        ));
        await tester.pumpAndSettle();
      ...
      testWidgets('does not wrap when not full width', (tester) async {
        await tester.pumpWidget(wrapInApp(
          const CustomButton(text: 'Not Full', isFullWidth: false),
        ));
        await tester.pumpAndSettle();
    ...
    group('icon', () {
      ...
      testWidgets('does not show icon when icon is null', (tester) async {
        await tester.pumpWidget(wrapInApp(
          const CustomButton(text: 'No Icon'),
        ));
        await tester.pumpAndSettle();
    ...
    group('sizes', () {
      ...
      testWidgets('medium size renders (default)', (tester) async {
        await tester.pumpWidget(wrapInApp(
          const CustomButton(text: 'Medium'),
        ));
        await tester.pumpAndSettle();
